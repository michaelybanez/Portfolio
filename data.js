...
const DB = {
  ...
  visualWorks: [
    ...
    { id: 14, title: 'Feed Post', category: 'Social Media', span: 'md:col-span-2 lg:col-span-2', url: './images/socialmedia-feedpost-03.webp', hidden: true },
    ...
    { id: 18, title: 'Brochure', category: 'Print Collateral', span: 'md:row-span-2 lg:row-span-2', url: './images/printcollateral-brochure-03.webp', hidden: true },
    { id: 19, title: 'Logo Mockup — Smadar Events', category: 'Brand Identity', span: 'md:col-span-2 lg:col-span-2', url: './images/brandidentity-logomockup-04.webp', hidden: true },
    ...
    { id: 22, title: 'Flyer', category: 'Print Collateral', span: 'md:row-span-2 lg:row-span-2', url: './images/printcollateral-flyer-01.webp', hidden: true },
    { id: 23, title: 'Business Card Mockup — Stitch BKLYN', category: 'Brand Identity', span: 'md:col-span-2 lg:col-span-2', url: './images/brandidentity-businesscard-01.webp', hidden: true },
    ...
    { id: 27, title: 'Letterhead — Guilasons Furniture', category: 'Brand Identity', span: 'md:row-span-2 lg:row-span-2', url: './images/brandidentity-letterhead-01.webp', hidden: true },
    ...
    { id: 32, title: 'Brochure', category: 'Print Collateral', span: 'md:col-span-2 lg:col-span-2', url: './images/printcollateral-brochure-02.webp', hidden: true },
  ]
